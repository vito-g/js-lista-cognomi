...
// assegnata una var che indica la posizione del cognome utente all'interno dell'array (precedentemente aggiornato e ordinato)
var posizioneArray = aggiornamento.indexOf(surname);
console.log(surname + ' occupa la posizione numero ' + posizioneArray + ' all\'interno dell\'array.' );
